...
| `china-wealth-assets` | `china-wealth-assets` | Normalized local export/package baseline for fund, wealth, cash-management holdings, transactions, asset snapshots, Excel/legacy-XLS/HTML-table/JSON/CSV/ZIP inputs, source audit, platform/field/account/asset-surface/currency coverage, asset value summary, and SoulMirror lake sync |
