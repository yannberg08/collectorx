...
| `ticktick` + `calendar` + `task-calendar-investor` | 任务、日历、交易计划、复盘提醒，含 ZIP 跳过成员审计和逐文件解析结果；lens 汇总研究任务、交易计划、复盘提醒、财报日程、调研会议和风险检查面谱 | `baseline+audit` | 滴答 OAuth、Apple/Google/Outlook/飞书等真实日历 |
