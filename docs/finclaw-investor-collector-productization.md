...
| `social-activity` + `social-investment-influence` | 微博、B站、小红书影响源和弱证据 lens | `baseline+audit`；manifest 记录平台/动作/弱证据字段覆盖、影响源可用面、逐输入解析结果、跳过文件/ZIP 成员原因和 preview-only 边界 | 真实平台导出、创作者 allowlist、弱证据回测 |
