...
| `wechat-favorites` + `wechat-article-favorites` | 微信收藏、公众号文章动作和投资文章 lens | `baseline+audit`；manifest 记录动作覆盖、字段覆盖、逐输入解析结果、跳过文件/ZIP 成员原因、内容策略和 generic-to-lens 边界 | 真实微信收藏库、公众号阅读动作、标签 allowlist |
