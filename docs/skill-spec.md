...
| investor-source-collectors | 8+ | 投资分身分类、路由和 lens 证据包工具；research-documents 已补逐输入审计和截图 metadata-only/no-OCR 边界，investment-notes 已补复盘/规则库/checklist/估值假设/研究记录面谱，不替代通用/垂直源采集器 |
