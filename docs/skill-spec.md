...
| financial-news-usage | 8+ | 财经资讯使用痕迹垂直采集器 baseline；支持授权文件/目录/ZIP/直接与 ZIP 内 Chromium/Safari 浏览器历史副本、平台/动作/主题覆盖、搜索/订阅/提醒/停留/访问行为覆盖、浏览器来源计数、逐输入来源审计、跳过原因、使用边界证明和凭证字段过滤，仍需真实财联社/华尔街见闻/格隆汇账号验证 |
